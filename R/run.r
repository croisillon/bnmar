...
table <- read.csv('~/tmp/int24.b.csv', header=T, sep=";", stringsAsFactors=F );
...
write.table(xmeans_table, file = "~/tmp/clust.csv", sep = ";", col.names = NA, qmethod = "double")
...
# write.table(dbscan_table, file = "/media/denis/WD50/con/dm/03_netflow/250/clustering/int8.dbscan_clustering.csv", sep = ";", col.names = NA, qmethod = "double")
...
# write.table(em_table, file = "/media/denis/WD50/con/dm/03_netflow/250/clustering/int8.em_clustering.csv", sep = ";", col.names = NA, qmethod = "double")
